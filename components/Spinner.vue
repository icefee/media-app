<template>
    <svg v-bind="attrs" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <rect width="2.8" height="12" x="1" y="6" rx="2" :fill="fillStyle">
        ...
        <rect width="2.8" height="12" x="5.8" y="6" rx="2" :fill="fillStyle">
        ...
        <rect width="2.8" height="12" x="10.6" y="6" rx="2" :fill="fillStyle">
        ...
        <rect width="2.8" height="12" x="15.4" y="6" rx="2" :fill="fillStyle">
        ...
        <rect width="2.8" height="12" x="20.2" y="6" rx="2" :fill="fillStyle">
